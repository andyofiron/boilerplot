<template>
    <div class="chart-box" ref="draggableContainer" @mousedown="dragMouseDown" @mousemove="dragging" @mouseup="boxDrop"
        :style="isSelected() ? this.cStyle : this.sStyle">
        <input v-if="this.editingMode_box" ref="inputbox" class="chart-boxContents" v-model="this.boxText">
